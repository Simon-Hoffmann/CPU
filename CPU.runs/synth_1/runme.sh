...
HD_PWD='C:/Users/Simon/Desktop/CPU/CPU/CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hoffmann.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hoffmann.tcl
